...
function useLocalStorage (key, cache, initialValue) {
    ...
    var _a = useState(initialValue), _ = _a[0], setCachedItem = _a[1];
    function getItem() {
        try {
...
function Auth0Provider(_a) {
    ...
    var auth = useRef(new Auth0(audience, domain, clientId, callbackUrl, logoutUrl, renewalThreshold)).current;
...
function Auth0CallbackRoute(_a) {
    ...
    return (React.createElement(Route, __assign({}, rest, { path: path, render: function (props) { return (React.createElement(CallbackComponent, __assign({}, props, { successTo: successTo, errorTo: errorTo }))); } })));
}

export { AFTER_LOGIN_PATH_KEY, Auth0 as Auth, Auth0CallbackRoute, Auth0Context, Auth0Provider, CURRENT_AUTH0_USER_KEY, useAuth0 };
